...
function formUploadCallback(result,object,typeObject) {
          console.log("Upload OK:", result);
            ...
            $.ajax({
              ...
              success: function(response){
               if(typeObject==3)
                $("#div_document"+object).empty().append(response);
               else if(typeObject==4)
              $("#div_documentbudget"+object).empty().append(response);
               else  $("#Document").empty().append(response);
