 ...
 */
class Structure extends \Entity\Structure implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Entity\\Structure' . "\0" . 'id', '' . "\0" . 'Entity\\Structure' . "\0" . 'libelle', '' . "\0" . 'Entity\\Structure' . "\0" . 'region', '' . "\0" . 'Entity\\Structure' . "\0" . 'cercle', '' . "\0" . 'Entity\\Structure' . "\0" . 'commune', '' . "\0" . 'Entity\\Structure' . "\0" . 'status');
        }
    ...
    public function setCercle($cercle)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCercle', array($cercle));

        return parent::setCercle($cercle);
    }
    ...
    public function getCercle()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCercle', array());
